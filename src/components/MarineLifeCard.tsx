...
const MarineLifeCard = ({ species, onClick }: MarineLifeCardProps) => {
  ...
  return (
    <Card 
      className="overflow-hidden bg-ocean-800/50 border-ocean-700 hover:shadow-lg hover:shadow-ocean-500/20 transition-all hover:-translate-y-1 h-full flex flex-col cursor-pointer"
    ...
    >
      ...
      <CardContent className="pt-4 flex-grow flex flex-col">
        ...
        <p className="text-ocean-200 text-sm mb-4 line-clamp-3 flex-grow">
          {species.description}
        </p>
