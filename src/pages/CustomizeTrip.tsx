...
// Language/internationalization strings can be separated out if needed for scale
...
const CustomizeTrip = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-ocean-900 py-10 px-4">
      <div className="w-full max-w-lg bg-ocean-800 rounded-xl shadow-lg p-8 text-white">
        <h1 className="mb-1 text-3xl md:text-4xl font-bold text-center">Plan Your Dive Trip</h1>
        <p className="mb-8 text-center text-ocean-100">Just a few fields to get you started.</p>
